...
$stmt = $db->prepare("SELECT u.*,c.name FROM UserCompetitions u, Competitions c WHERE u.user_id = $theID AND c.id=u.competition_id ORDER BY created DESC LIMIT :offset,:count");
