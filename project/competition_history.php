...
$query = "SELECT u.count(*) as total FROM UserCompetitions u JOIN Competitions c ON c.id=u.competition_id WHERE u.user_id = $theID ORDER BY created DESC";
paginate($query, [], $per_page);


//$query = "SELECT count(*) as total FROM UserCompetitions WHERE user_id = $theID ORDER BY created DESC";
$stmt = $db->prepare("SELECT u.count(*) as total FROM UserCompetitions u JOIN Competitions c ON c.id=u.competition_id WHERE u.user_id = $theID ORDER BY created DESC LIMIT :offset,:count");
