...
$stmt2 = $db->prepare("SELECT c.* FROM Competitions c WHERE c.expires > current_timestamp AND paid_out = 0 ORDER BY expires ASC LIMIT :offset, :count");//Use this one or you can only see what you created
...
$stmt2->bindValue(":count", $per_page, PDO::PARAM_INT);
$stmt2->bindValue(":id", get_user_id());
$stmt2->execute();
$e = $stmt2->errorInfo();
if($e[0] != "00000"){
